...
const Disclaimer = () => {
  return (
    ...
    <div className="disclaimer-div">
        ...
        <div>The information provided by ("we," "us," or "our") on coinpresale.net is for general informational purposes only. 
        ...
        <div>
            The coinpresale.net cannot and does not contain legal advice.
            The information provided for the website is about analytic research and information purposes only and is not a substitute for professional advice.
            Accordingly, before taking any actions based upon such information, we encourage you to consult with the appropriate professionals. 
            We do not provide any kind of legal advice. THE USE OR RELIANCE OF ANY INFORMATION CONTAINED ON THE SITE IS SOLELY AT YOUR OWN RISK.
        </div>
    </div>
